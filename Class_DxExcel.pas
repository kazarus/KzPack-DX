...
type
  ...
  public
    ...
    //rename it
    //#class procedure SetCellTxt(ASheetBook: TdxSpreadSheet; ACol, ARow: Integer; AText: string;AFontName: TFontName='宋体'; AFontSize: Integer=10;AAlign: TdxSpreadSheetDataAlignHorz;ADataType:TDxDataType=cxdtText);
  ...
  {TFkExcel=class(TDxExcel) //分栏导出.Fuck.Excel.
  public
...
begin
  ...
  case DataType of
    ...
    cxdtDoub :Result:=$04;
    cxdtDate :Result:=$0E;
    cxdtLongText  :Result:=$22;//老版本.TdxSpreadSheet.长字段类型
    cxdtLongTextEx:Result:=$23;//新版本.TdxSpreadSheet.长字段类型
